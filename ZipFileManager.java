package com.javarush.task.Projects.Archiver;

import com.javarush.task.Projects.Archiver.exception.PathIsNotFoundException;
import com.javarush.task.Projects.Archiver.exception.WrongZipFileException;
...
public class ZipFileManager {
    ...
    public void createZip(Path source) throws Exception {
        // Проверяем, существует ли директория, где будет создаваться архив. При необходимости создаем ее
    ...
    public List<FileProperties> getFilesList() throws Exception {
        ...
        try (ZipInputStream zipInputStream = new ZipInputStream(Files.newInputStream(zipFile))) {
            ...
            while (zipEntry != null) {
                // Поля "размер" и "сжатый размер" неизвестны, пока элемент не будет прочитан. вычитаем его в байтовый выходной поток
